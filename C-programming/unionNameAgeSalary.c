/*wap to create a union with the fields line
 name[10]
 int age 
 float salary
 double annual income
 create two variables of this union type with the values provided by the user at run time
 print the size of variable and the respective values on the screen*/
 #include<stdio.h>
 ...
 void main()
 {
    union unionNameAgeSalary p1, p2;
    printf("Name:\n");
    scanf("%s",p1.name);
    printf("Age:\n");
    scanf("%d",&p1.age);
